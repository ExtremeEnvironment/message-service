...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "MessageService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "MessageService API";

        private String description = "MessageService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "MessageService";
